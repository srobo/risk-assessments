...
\begin{description}
\item[Activity being assessed:] Student Robotics Competition (6 - 7 April, 2019)
\item[Location:] Southampton University Students Union (SUSU)
\item[Persons at risk:] Competitors, Team Leaders, Blueshirts, SUSU Staff, Visitors
\end{description}
...
\risk{Injury to competitors, Blueshirts, and members of the public due to unsafe robots}
{Robots subject to a safety inspection before entry into an arena.
Robots re-inspected randomly throughout the event, entry into the arena can be revoked at any time.
Anyone identifying a potential safety issue to report it to the safety inspector.
Arena access controlled by Blueshirts - maximum of 4 teams at a time, and modification of robots inside the arena is banned.
